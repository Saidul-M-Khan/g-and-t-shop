...
const Header = () => {
  ...
  return (
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 bg-white sticky top-0">
          ...
          <li>
            <Link to="/cart" aria-label="Cart" title="Cart">
              <div className="relative py-3">
                ...
                <p className="absolute bottom-5 left-6 font-bold text-purple-600">
                  {cart.length}
                </p>
              </div>
            </Link>
